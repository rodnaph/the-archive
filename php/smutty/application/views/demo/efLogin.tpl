...
{form url={ action="efDoLogin" } update="LoginResult" feedback="LoginResult" gpgSigned="true"}
...
{form url={ action="efDoRegister" } feedback="RegisterResult"
...
<pre>
#
#  views/demo/efLogin.tpl
#
{ldelim}form url={ldelim} action="efDoLogin" {rdelim} update="LoginResult"
...
{ldelim}form url={ldelim} action="efDoRegister" {rdelim} feedback="RegisterResult"
...
class DemoController extends Smutty_Controller {ldelim}
	...
	function efDoLoginAction( $data ) {ldelim}
	...
	function efDoRegisterAction( $data ) {ldelim}
